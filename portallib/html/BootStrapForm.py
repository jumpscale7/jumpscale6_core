...
class BootStrapForm:
    ...
    def addForm(self,form,postBackUrl=""):
        ...
        if postBackUrl=="":
            if len(form.references.objects.keys())==1:
                okey=form.references.objects.keys()[0]
...
class References():
    ...
    def __init__(self,actor):
        self.refs={}
        self.db=actor.dbmem
        self.id=o.base.idgenerator.generateGUID()
        self.counter=0
        self.objects={}
...
""" 
    ...
    def getReference(self,obj,reference):
        """
        example:
        user=o.apps.system.usermanager.model_user_new()
