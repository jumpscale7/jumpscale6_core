...
class OSISInstanceNoDB:
    ...
    def __init__(self,appname,actorname,modelname,classs):
        ...
        self.spec=o.core.specparser.getModelSpec(self.appname,self.actorname,self.modelname)
        ...
        for propspec in self.spec.properties:
            tags=o.core.tags.getObject(propspec.tags)
    ...
    def _getObj(self, obj):
        if isinstance(obj, dict):
            attributes = obj.copy()
            return o.code.dict2pymodelobject(self.modelclass(), attributes)
        else:
            return obj
...
class OSISRemoteOSISInstance(OSISInstanceNoDB):
    ...
    def get(self,guid = None, id = None):
        ...
        return o.code.dict2pymodelobject(self.modelclass(), obj)
...
class OSISInstance(OSISInstanceNoDB):
    ...
    def set(self,obj,index=False):
        ...
        if 'guid' not in data or not data['guid']:
            data['guid'] = o.base.idgenerator.generateGUID()
    ...
    def _index(self,obj):
        if self.indexer<>None:
            spec=o.core.specparser.getModelSpec(self.appname,self.actorname,self.modelname)
            indexcontent=self.indexer.indexdef.getIndexArgs(obj,o.core.osis.objectToText4Index(obj,spec))
    ...
    def get(self,guid=None,id=None,createIfNeeded=False,ignoreError=False):
        ...
        return o.code.dict2pymodelobject(self.modelclass(),value)
    ...
    def destroy(self):
        ...
        # if o.core.osis.osisInstances.has_key(kkey):
        #     o.core.osis.osisInstances.pop(kkey)
