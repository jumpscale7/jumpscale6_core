...
class QSocketServerHandler(SocketServer.BaseRequestHandler):
    ...
    def senddata(self,data):
        #message=o.core.messagehandler.data2Message(20,data)
        #for i in range(1000):
    ...
    def handle(self):
        ...
        while True:
            ...
            if data.find("**connect**")<>-1:
                ...
                result=o.system.socketserver._handledata(data)
                if result<>None:
                    try:
...
class QSocketServer():
    def __init__(self,addr,port,key,datahandler):
        ...
        self.addr=addr
        self.key=key
        o.system.socketserver.key=key
        self.type="server"
        o.system.socketserver._handledata=datahandler
