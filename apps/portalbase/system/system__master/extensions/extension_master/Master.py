...
class Master():
    ...
    def _init(self):
        if self.inited == False:
            self.model = j.apps.system.master.models.gridmap
            ...
            j.core.portal.runningPortal.gridmap = self.gridmap
            self.inited = True
    ...
    def gridMapGetRedisClusterFromAppActorName(self, appname, actorname):
        ...
        if key in self.gridmap.actor2redis:
    ...
    def gridMapGetActorInstance(self, appname, actorname, instance):
        ...
        if key in self.gridmap.actorinstances:
    ...
    def gridMapRegisterAppserver(self, ismaster, ipaddr, port, secret):
        ...
        appserver.lastnotified = j.base.time.getTimeEpoch()
        appserver.start = j.base.time.getTimeEpoch()
    ...
    def gridMapRegisterActor(self, appname, actorname, instance, appserverHost, redisHost, arakoonHost):
        ...
        actor.start = j.base.time.getTimeEpoch()
