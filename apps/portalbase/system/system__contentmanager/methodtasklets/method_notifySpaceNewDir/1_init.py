...
def main(o, args, params, actor, tags, tasklet):
    ...
    if params.spacepath==None:
        space=o.core.portal.runningPortal.webserver.spacesloader.getSpaceFromId(params.spacename.lower())
        params.spacepath= space.model.path

    params.spacepath=params.spacepath.replace("\\","/")

    params.dirname=o.system.fs.getDirName( params.path+"/", lastOnly=True)
    return params
