...
def action():
    ...
    for mac,val in netinfo.iteritems():
        ...
        nic_key=name
        cacheobj=j.processmanager.cache.nicobject.get(id=nic_key)
    ...
    #find deleted nices
    for nic_key in j.processmanager.cache.nicobject.monitorobjects.keys():
    ...
    j.processmanager.cache.nicobject.monitorobjects=result
