...
def main(j, args, params, tags, tasklet):
    ...
    pid = args.tags.getDict().get("pid") if not args.tags.getDict().get("pid", "").startswith('$$') else None
    jid = args.tags.getDict().get("jid") if not args.tags.getDict().get("jid", "").startswith('$$') else None
