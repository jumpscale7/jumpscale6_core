...
class QPackageStateObject():
    ...
    def setDebugMode(self, mode=1):
        '''
        enables debug mode for owpackage
        '''
        self.debugMode = mode
        self._save()
    ...
    def setIsPendingReconfiguration(self, value):
        """
        Changes the owpackage's config file to see whether reconfiguration is required or not depending on the value given as parameter
        """
    ...
    def getIsPendingReconfiguration(self):
        """
        Returns true is the owpackage needs reconfiguration
        """
    ...
    def setPrepared(self, prepared):
        """
        Changes the owpackage config file to whether the package has been prepared or not depending on the parameter given
        """
