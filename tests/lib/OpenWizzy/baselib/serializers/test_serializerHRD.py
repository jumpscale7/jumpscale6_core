...
class test_SerializerHRD(unittest.TestCase):
    ...
    def test_loadsdumps(self):
        ...
        dumped = j.db.serializers.hrd.dumps(test_dumps3)   
        ...
        dumped = j.db.serializers.hrd.dumps(test_dumps4)   
        self.assertEquals(dumped, 'disks.[0].diskname = disk1\ndisks.[0].size. = 256\ndisks.[1].diskname = disk2\ndisks.[1].size.[0]. = 1\ndisks.[1].size.[1]. = 3\ndisks.[1].size.[2]. = 4\nname = machinename\n')
        loaded = j.db.serializers.hrd.loads(dumped)
        ...
        dumped = j.db.serializers.hrd.dumps(test_dumps5)   
        ...
        dumped = j.db.serializers.hrd.dumps(test_dumps6)   
        ...
        dumped = j.db.serializers.hrd.dumps(test_dumps16)   
        ...
        test_dumps20 = {u'passwd': u'admin', 
                        ...
                        u'id': u'admin'}
        dumped = j.db.serializers.hrd.dumps(test_dumps20)
        ...
        dumped = j.db.serializers.hrd.dumps(test_dumps21)
        loaded = j.db.serializers.hrd.loads(dumped)
