...
if q.system.net.waitConnectionTest("127.0.0.1",80,15)==False or q.system.net.waitConnectionTest("127.0.0.1",9999,15)==False:
...
client2=q.core.appserver6.getAppserverClient("127.0.0.1",9999,"1234")
usermanager=client2.getActor("system","usermanager",instance=0)

client3=q.core.appserver6.getAppserverClient("127.0.0.1",9999,"1234")
filemgr=client3.getActor("system","filemanager",instance=0)

ROOTPATH='c:/data/ROOT/'
STORPATH="c:/data/files"

q.system.fs.createDir(STORPATH)
...
def main():
    ...
    q.errorconditionhandler.processErrorConditionObject=processErrorConditionObject
